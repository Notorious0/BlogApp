...
async function populate() {
    ...
    if(count == 0) { 
        ...
        const users = await User.bulkCreate([
            {fullname:"halit onur",email:"shalitonur@gmail.com",password: await bcrypt.hash("1234567",10)},
            {fullname:"",email:"nur@gmail.com",password: await bcrypt.hash("1234567",10)},
            {fullname:"",email:"fatma@gmail.com",password: await bcrypt.hash("1234567",10)},
            {fullname:"",email:"suat@gmail.com",password: await bcrypt.hash("1234567",10)},
            {fullname:"x",email:"x@gmail.com",password: await bcrypt.hash("1234567",10)},
        ]);
